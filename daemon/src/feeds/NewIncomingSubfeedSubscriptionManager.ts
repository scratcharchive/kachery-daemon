...
import { durationMsecToNumber, elapsedSince, FeedId, MessageCount, NodeId, nowTimestamp, scaledDurationMsec, SubfeedHash, zeroTimestamp } from "../common/types/kacheryTypes"
...
class IncomingSubfeedSubscription {
    ...
    constructor(private node: KacheryDaemonNode, public remoteNodeId: NodeId, public feedId: FeedId, public subfeedHash: SubfeedHash) {
    }
    renew() {
